package com.meowu.commons.mybatis.mysql.criteria;
...
public class Criterion{
    ...
    public Criterion in(List<Object> value){
        AssertUtils.notEmpty(value, "computed values must not be null");
    ...
    public Criterion and(Criterion... criteria){
        AssertUtils.notEmpty(criteria, "computed values must not be null");
